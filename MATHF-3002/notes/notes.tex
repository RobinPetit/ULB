...
\begin{déf}\label{déf:convergence Schwartz} Soit $(u_k)_{k \in \N} \in \mathcal S^\N$, $u \in \mathcal S$, on dit que $u_k$ converge vers $u$ lorsque $k \to \pinfty$
...
\begin{thm}\label{thm:Fourier continu sur Schwartz} Soit $u \in \mathcal S$. Alors~:
\begin{enumerate}
