...
\newcommand{\showproofs}{}

\newenvironment{comm}%
{\ifthenelse{\isundefined{\showproofs}}%
	{\expandafter\comment}%
	{}%
}%
{\ifthenelse{\isundefined{\showproofs}}%
...
\begin{enumerate}
	...
	\end{itemize}
	On déduit de ces deux cas $f^{P_n} \xrightarrow[n \to \pinfty]{\mathcal L\text{-ae}} H$ et donc $H$ est mesurable puisque limite de fonctions mesurables. Du plus, on sait
	...
	par le théorème de la convergence monotone~:
